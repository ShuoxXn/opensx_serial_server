/*
 * @Author: Orion
 * @Date: 2024-01-23 15:53:57
 * @LastEditors: Orion
 * @LastEditTime: 2024-05-07 11:19:18
 * @FilePath: \SERIIAL_SERVER\main\sx_dns_server.c
 * @Description:
 *
...
static void close_dns_socket(int sock) {
  if (sock < 0) {
    return;
  }
